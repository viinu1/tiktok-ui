...
export const InboxIcon = ({ className, width = '2.8rem', height = '2.8rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const SearchIcon = ({ className, width = '2.8rem', height = '2.8rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const UserGroupIconActive = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const OptionIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const BlockIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => {
    <svg
        className={className}
        width={width}
        data-e2e=""
